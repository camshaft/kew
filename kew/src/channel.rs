...
use crate::ring_deque::{self, RingDeque};
use core::{
    fmt,
...
impl<T> Sender<T> {
    pub async fn send_back(&self, msg: T) -> Result<(), Closed> {
        // TODO apply backpressure
        self.force_send_back(msg)?;
        Ok(())
    }

    #[inline]
    pub fn force_send_back(&self, msg: T) -> Result<Option<T>, Closed> {
    ...
    pub async fn send_front(&self, msg: T) -> Result<(), Closed> {
        // TODO apply backpressure
        self.force_send_front(msg)?;
        Ok(())
    }

    #[inline]
    pub fn force_send_front(&self, msg: T) -> Result<Option<T>, Closed> {
